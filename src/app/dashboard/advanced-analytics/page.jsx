...
function AdvancedAnalytics() {
  ...
  return (
    <div className="bg-[#f8f9fa] dark:bg-[#1C1C1C] h-screen p-2 md:p-5 lg:p-10">
      ...
      <div className="md:grid-cols-2 lg:grid-cols-3 grid grid-cols-1 gap-5 mt-10">
        {/* User Stats Card */}
        ...
        <div className="bg-white dark:bg-[#242424] p-6 rounded-lg shadow-md">
          <h3 className="mb-4 text-lg font-semibold">Form Categories</h3>
          <div className="h-64">
            {isCategorizing ? (
              <div className="flex justify-center items-center h-full">
                <div className="border-primary-blue w-8 h-8 rounded-full border-b-2 animate-spin"></div>
        ...
        <div className="bg-white dark:bg-[#242424] p-6 rounded-lg shadow-md">
          <h3 className="mb-4 text-lg font-semibold">Response Trends</h3>
          <div className="h-64">
      ...
      <div className="md:grid-cols-2 grid grid-cols-1 gap-5 mt-10">
        {/* Top Performing Forms */}
        <div className="bg-white dark:bg-[#242424] p-6 rounded-lg shadow-md">
          <h3 className="mb-4 text-lg font-semibold">Top Performing Forms</h3>
        ...
        <div className="bg-white dark:bg-[#242424] p-6 rounded-lg shadow-md">
          <h3 className="mb-4 text-lg font-semibold">Least Performing Forms</h3>
          <div className="space-y-4">
